...
SECRET_KEY = 'django-insecure-a^y)o_!-92k=6ok)c1*tef7i0y^pu2d=%z!#gcwc4wt=q6)9l*'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        'APP': {
            'client_id': '480658818279-dq44fdok85lr2bogsnfb2aj5i7c0t4nv.apps.googleusercontent.com',
            'secret': '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',
            'key': ''
        }
    }
}
...
# settings.py
AUTHENTICATION_BACKENDS = [
    # Replace with the path to your custom authentication backend
